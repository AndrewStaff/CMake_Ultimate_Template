...
// configuration step. It creates a namespace called `CMake_Ultimate_Template`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", CMake_Ultimate_Template::cmake::project_name, CMake_Ultimate_Template::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", CMake_Ultimate_Template::cmake::project_version);
      return EXIT_SUCCESS;
    }
